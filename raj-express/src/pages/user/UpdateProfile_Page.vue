...
const fetchUserData = async (token) => {
  try {
    const response = await fetch('http://localhost/AMBOT-KAPOYA-NA/raj-express/backend/controller/profile.php', {
      headers: {
...
const signup = async () => {
  ...
  try {
    const response = await fetch('http://localhost/AMBOT-KAPOYA-NA/raj-express/backend/controller/update_profile.php', {
      method: 'POST',
      headers: {
...
const handleFileUpload = async (event) => {
  ...
  if (file) {
    ...
    try {
      const response = await fetch('http://localhost/AMBOT-KAPOYA-NA/raj-express/backend/uploads/', {
        method: "POST",
        body: formData
      });
      const result = await response.json();
